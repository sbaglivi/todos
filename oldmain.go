...
type AppConfig struct {
	StoreFormat   string `mapstructure:"storeFormat"`
...
func oldmain() {
	...
	viper.SetConfigName("todos-settings")
	viper.SetConfigType("yaml")
	// Bind the configuration to the struct
	...
	if config.StoreLocation == "" {
		config.StoreLocation = configPath
	}
	fmt.Println(config)
